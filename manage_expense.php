  					...
  					<div class="row justify-content-md-center">
    					<div class="col-xm-3" style="">
      						 <div class="card" style="width: 18rem;">
  								<div class="card-body">
    								<h5 class="card-title">Record Expense Data</h5>
    								<p class="card-text">Used for adding information of expenses on various commodities.</p>
    								<a href="expense.php" class="card-link">Proceed</a>
  								</div>
							</div>
    					</div>
    					...
    					<div class="col-xm-3" style="">
      						<div class="card" style="width: 18rem;">
  								<div class="card-body">
    								<h5 class="card-title">View Expense Record</h5>
    								<p class="card-text">Used for Viewing Expense Records</p><br>
    								<a href="expense_view.php" class="card-link">Proceed</a>
  								</div>
							</div>
    					</div>
  					</div>
